...
app.config['MAIL_USERNAME'] = 'hp.weber45@gmail.com '  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'ezngkgpwdopgikja'   # Your Gmail password or app-specific password
