...
app.config['MAIL_USERNAME'] = 'hotsfetter.andreas@gmail.com '  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'wjtdfixmzwgatwmt'   # Your Gmail password or app-specific password
