...
app.config['MAIL_USERNAME'] = 'alexchen1407@gmail.com'  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'cqpkdeouekdhgysd'   # Your Gmail password or app-specific password
