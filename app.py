...
app.config['MAIL_USERNAME'] = 'haydencdric@gmail.com '  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'lxpsbrpznyxyctwg'   # Your Gmail password or app-specific password
